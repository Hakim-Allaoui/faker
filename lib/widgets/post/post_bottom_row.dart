...
class PostBottomRow extends StatefulWidget {
  ...
  const PostBottomRow({Key key, this.addComment, this.post}) : super(key: key);
        ...
        InkWell(
          onTap: () {
            setState(() {
              ...
              // selectedIndex == 0 ? widget.post.postReactions.reactionsCount++ : widget.post.postReactions.reactionsCount--;
            });
          },
          onLongPress: () {
            showReactsRow();
          ...
          child: Row(
            ...
            children: <Widget>[
              Padding(
                ...
                child: Hero(
                  tag:
                      "${_list[selectedIndex].split('/').last.split('.').first}",
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Text(
                ' '+'comment'.plural(0),
                style: MyTextStyles.fbSubTitleBold
                    .apply(color: Palette.greyDark, fontSizeFactor: 0.9),
              )
            ],
          ),
        ),
          ...
          children: <Widget>[
            Transform(
              ...
              transform: Matrix4.rotationY(
                  Tools.isDirectionRTL(context) ? math.pi : 0),
              child: Padding(
                padding: const EdgeInsets.all(8.0),
                child: SvgPicture.asset(
