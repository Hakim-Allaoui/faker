        ...
        InkWell(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Text('comment', style: MyTextStyles.fbSubTitleBold.apply(color: Palette.greyDark, fontSizeFactor: 0.9),)
            ],
          ),
        ),
        Row(
          ...
          children: <Widget>[
            ...
            Text('share', style: MyTextStyles.fbSubTitleBold.apply(color: Palette.greyDark, fontSizeFactor: 0.9),)
          ],
        ),
      ],
    );
